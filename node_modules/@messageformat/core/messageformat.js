(function (global, factory) {
  ...
  var parser = createCommonjsModule(function (module, exports) {
    ...
    var ParseError = /*#__PURE__*/function (_Error) {
      ...
      function ParseError(lt, msg) {
        ...
        return _super.call(this, lexer.lexer.formatError(lt, msg));
      }
  ...
  var Compiler = (function () {
      ...
      Compiler.prototype.compile = function (src, plural, plurals) {
          ...
          this.arguments = [];
          var r = parser.parse(src, parserOptions).map(function (token) { return _this.token(token, null); });
      ...
      Compiler.prototype.cases = function (token, pluralToken) {
          ...
          var r = token.cases.map(function (_a) {
              ...
              return property(null, key.replace(/^=/, '')) + ": " + _this.concatenate(s, false);
          });
          if (needOther) {
              var type = token.type;
      ...
      Compiler.prototype.setDateFormatter = function (_a, args, plural) {
          ...
          if (argStyle &&
              ...
              var key = identifier("date_" + locale + "_" + argSkeletonText_1, true);
              if (!this.runtimeIncludes(key, 'formatter')) {
      ...
      Compiler.prototype.setNumberFormatter = function (_a, args, plural) {
          ...
          if (param.length === 1 && param[0].type === 'content') {
              ...
              var key = identifier("number_" + locale + "_" + fmtArg_1, true);
              if (!this.runtimeIncludes(key, 'formatter')) {
  ...
  var MessageFormat = (function () {
      ...
      MessageFormat.prototype.compile = function (message) {
          ...
          var fn = new (Function.bind.apply(Function, __spreadArray(__spreadArray([void 0], __read(nfArgs)), [fnBody])))();
          return fn.apply(void 0, __spreadArray([], __read(fnArgs)));
      };
